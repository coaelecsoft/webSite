...
/**
 * This is the model class for table "sssslave".
 *
 * @property int $id
 * @property int|null $ss_slave_id
 ...
 * @property string|null $menu-icon
 * @property string|null $icon
 * @property string|null $image
 * @property string $post_option_1
 *
 * @property Ssslave $ssSlave
 */
class Sssslave extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ss_slave_id', 'no', 'post_code', 'zoom', 'data_1', 'data_2'], 'integer'],
             [['logo','back'], 'file'],
            ...
            [['ss_slave_id'], 'exist', 'skipOnError' => true, 'targetClass' => Ssslave::class, 'targetAttribute' => ['ss_slave_id' => 'id']],
        ];
    }
    ...
    /**
     * Gets query for [[SsSlave]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSsSlave()
    {
        return $this->hasOne(Ssslave::class, ['id' => 'ss_slave_id']);
    }
}
