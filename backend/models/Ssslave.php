...
/**
 * This is the model class for table "ssslave".
 *
 * @property int $id
 * @property int|null $sub_slave_id
 ...
 *
 * @property Sssslave[] $sssslaves
 * @property Subslave $subSlave
 */
class Ssslave extends \yii\db\ActiveRecord
{
     public $logo;
    public $back;
    /**
    ...
    {
        return [
            [['sub_slave_id', 'no', 'post_code', 'zoom', 'data_1', 'data_2'], 'integer'],
            [['logo','back'], 'file'],
            [['menu_option', 'page_active', 'page_option', 'page_option_1', 'description_sr_latn', 'text_sr_latn', 'basic_sr_latn', 'description_en', 'text_en', 'basic_en', 'post_option_1'], 'string'],
            ...
            [['sub_slave_id'], 'exist', 'skipOnError' => true, 'targetClass' => Subslave::class, 'targetAttribute' => ['sub_slave_id' => 'id']],
        ];
    }
    ...
    /**
     * Gets query for [[Sssslaves]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSssslaves()
    {
        return $this->hasMany(Sssslave::class, ['ss_slave_id' => 'id']);
    }

    /**
     * Gets query for [[SubSlave]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSubSlave()
    {
        return $this->hasOne(Subslave::class, ['id' => 'sub_slave_id']);
    }
}
