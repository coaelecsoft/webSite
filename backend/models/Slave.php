 ...
 * @property Subslave[] $subslaves
 */
class Slave extends \yii\db\ActiveRecord
{
    public $logo;
    public $back;
    public $back1;
    ...
    {
        return [
            [['master_id', 'no', 'post_code', 'zoom', 'data_1', 'data_2'], 'integer'],
    ...
    /**
     * Gets query for [[Subslaves]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getSubslaves()
    {
        return $this->hasMany(Subslave::class, ['slave_id' => 'id'])->orderBy(['no' => SORT_ASC]);
    }
}
