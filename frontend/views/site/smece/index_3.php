...
<main role="main" class="flex-shrink-0">
    ...
    <!--
        ...
        <div class="text-page-header">
            <div class="container">
                <div>
                    <h1 style="background:rgba(222,222,222,.8);padding: 20px;text-align: center"><?= $slide->$main_title_name; ?></h1>  
                </div>
    ...
    <div class="my-slider" style="height:calc(100vh - 108px);background: lightgrey;overflow: hidden">
        
        <div id="move"  style="display: flex; width: calc(300vw);transition: 1s;">
            <div style="background: orange; width: 100vw; height:calc(100vh - 108px);display: flex;justify-content: center;align-items: center;transition: 1s">
                <h2> Prvi</h2>
            </div>
            <div style="background: blue; width: 100vw; height:calc(100vh - 108px);display: flex;justify-content: center;align-items: center;transition: 1s">
                <h2> Drugi</h2>   
            </div>
            <div style="background: lime; width: 100vw; height:calc(100vh - 108px);display: flex;justify-content: center;align-items: center;transition: 1s">
                <h2>Treci</h2>
            </div>
        </div>
