...
<main>  
    ...
    <header class="<?= 'text-image-' . $main->page_option_1 ?> my-container  page-main-header">
        <div class="text-panel">
                <nav>   
                     <?php if($main->subSlave->slave->master->menu_option == '0'){ ?>
                    <?=
                    ...
                    <?=
                    Html::a($main->subSlave->slave->master->$title_name, ['/site/master',
                       'page' => $main->subSlave->slave->master->$link_name,
                            // 'subpage' => $slave->$link_name,
                            // 'home' => Yii::$app->mycoms->wordtourl($body->home->link_sr_latn),
                            //'subhome' => Yii::$app->mycoms->wordtourl($body->link_sr_latn),
                            ], ['style' => '', 'class' => 'btn btn-primary', 'title' => 'Izmenite zaglavlje ove stranice']);
                    ...
                    ?>
                 <?=
                    Html::a($main->subSlave->slave->$title_name, ['/site/slave',
                       'page' => $main->subSlave->slave->master->$link_name,
                           'subpage' => $main->subSlave->slave->$link_name,
                            // 'home' => Yii::$app->mycoms->wordtourl($body->home->link_sr_latn),
                            //'subhome' => Yii::$app->mycoms->wordtourl($body->link_sr_latn),
                            ], ['style' => '', 'class' => 'btn btn-primary', 'title' => 'Izmenite zaglavlje ove stranice']);
                    ...
                    ?>
                <?=
                    Html::a($main->subSlave->$title_name, ['/site/subslave',
                       'page' => $main->subSlave->slave->master->$link_name,
                           'subpage' => $main->subSlave->slave->$link_name,
                        'subsubpage' => $main->subSlave->$link_name,
                            // 'home' => Yii::$app->mycoms->wordtourl($body->home->link_sr_latn),
                            //'subhome' => Yii::$app->mycoms->wordtourl($body->link_sr_latn),
                            ], ['style' => '', 'class' => 'btn btn-primary', 'title' => 'Izmenite zaglavlje ove stranice']);
    ...
    <?php
    if($main->sssslaves){
     foreach ($main->sssslaves as $slave) {
